  ...
  return (
    <main className="bg-background pb-20 md:pb-0 overflow-x-hidden">
      ...
      <section className="relative w-full h-[85vh] sm:h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 sm:px-12 md:px-16 lg:px-24 py-10 sm:py-14 md:py-20 lg:py-24 mx-4 md:mx-auto max-w-3xl lg:max-w-4xl xl:max-w-5xl w-full bg-black/20 md:bg-black/30 backdrop-blur-sm md:backdrop-blur-sm rounded-[2rem] md:rounded-[3rem] border border-white/10 md:border-white/20 shadow-2xl animate-fade-in-up">
